...
Public Class import_form_other
    ...
    Private Sub BTSubmit_Click(sender As Object, e As EventArgs) Handles BTSubmit.Click
        ...
        For Each importfile In importfiles
            ...
            copy(importfile, import_driveletter & ":\other\" & Format(import_projectid, "000") & "-" & Format(import_cameraid, "000") & "-" & Format(Hauptscreen.import_clipnumber, "000") & "-" & Format(randomint, "000") & "." & ext(ext.Count - 1))
    ...
    Private Sub import_form_other_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub CBCam_SelectedIndexChanged(sender As Object, e As EventArgs) Handles CBCam.SelectedIndexChanged
        ...
        import_cameraid = Convert.ToInt32(CBCam.SelectedIndex)
